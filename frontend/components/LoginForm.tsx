      ...
      <div className="w-full p-7 sm:p-8 rounded-[28px] bg-[#11182B] border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative overflow-hidden backdrop-blur-xl">
        ...
        {mode === "signin" ? (
          <form onSubmit={handleSignIn} className="space-y-4 relative z-10">
            ...
            {/* Continue with Google Button (Down the Password) */}
            <div className="pt-1">
              <button
                type="button"
                onClick={handleGoogleSignIn}
                disabled={loading}
                className="w-full py-2.5 rounded-xl bg-white text-[#0B1020] font-bold text-xs hover:bg-gray-100 hover:shadow-[0_4px_20px_rgba(255,255,255,0.2)] hover:-translate-y-0.5 transition-all duration-200 flex items-center justify-center gap-2.5 disabled:opacity-60 disabled:cursor-not-allowed"
              >
            ...
            <div className="relative my-2 flex items-center justify-center">
              ...
              <span className="absolute bg-[#11182B] px-3 text-[10px] uppercase tracking-wider text-[#A9B1C7]/60 font-semibold">
                OR
              </span>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-2xl bg-gradient-to-r from-[#8B7CFF] to-[#65DDF5] text-[#0B1020] font-bold text-sm hover:shadow-[0_8px_25px_rgba(139,124,255,0.35)] hover:-translate-y-0.5 transition-all duration-200 flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {loading ? (
                <>
